  ...
  return (
    <div className=" max-w-7xl mx-auto">
      <div className="flex items-center justify-between h-14">
        <Link to="/">
          <h1 className="font-bold md:font-extrabold text-2xl">Tiwari Eats</h1>
        </Link>
        <div className="md:flex items-center gap-10">
          ...
          <div className="hidden md:flex items-center gap-4">
            ...
            <div>
              {loading ? (
                <Button className="bg-gray-500 hover:bg-hoverOrange">
    ...
    <Sheet>
      ...
      <SheetContent className=" flex flex-col bg-white ">
        <SheetHeader className="flex flex-row items-center justify-between mt-2">
          <SheetTitle>Tiwari Eats</SheetTitle>
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="outline" size="icon">
                <Sun className="h-[1.2rem] w-[1.2rem] rotate-0 scale-100 transition-all dark:-rotate-90 dark:scale-0" />
        ...
        <SheetFooter className="flex flex-col gap-4">
          <div className="flex flex-row items-center gap-2">
            ...
            <h1 className="font-bold">Tiwari Eats</h1>
          </div>
          <SheetClose asChild>
            {loading ? (
